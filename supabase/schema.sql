...
alter table public.chatbot_messages add column if not exists conversation_id text;
alter table public.chatbot_messages add column if not exists ip_address text;
