  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      if (req.query.list === '1') {
        ...
        // Keep BOTH the team and support entries for someone who exists in both
        // (same email) — they belong under their respective tabs and the group
        // picker selects them per-row, so support-Harsh and team-Harsh are
