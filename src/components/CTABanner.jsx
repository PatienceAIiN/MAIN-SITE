    ...
    <section className="py-12 md:py-16 px-6">
      <div className="container mx-auto max-w-6xl">
        <motion.div
          ...
          className="relative rounded-[2.25rem] overflow-hidden bg-slate-900 text-white py-12 md:py-14 px-8 md:px-16 text-center shadow-2xl"
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-300 mb-7 max-w-xl mx-auto">{content.description}</p>
