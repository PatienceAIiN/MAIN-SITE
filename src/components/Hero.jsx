...
const Hero = ({ content, onAction }) => {
  ...
  return (
    <section id="home" className="relative isolate w-full min-h-[580px] md:min-h-[650px] bg-gradient-to-br from-slate-50 via-white to-slate-100 overflow-hidden">
      
      {/* Background Image Layer */}
      <div className="absolute inset-0 w-full h-full bg-white/35">
        <img 
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-white/95 via-white/85 to-white/25 z-[1]" />
      <div className="absolute inset-x-0 top-0 h-28 bg-gradient-to-b from-white/70 to-transparent z-[1]" />
      <motion.div
        aria-hidden="true"
      ...
      >
        <div className="h-full w-full rounded-full bg-indigo-200/40 blur-3xl" />
      </motion.div>
      <motion.div
        aria-hidden="true"
      ...
      >
        <div className="h-full w-full rounded-full bg-sky-200/40 blur-3xl" />
      </motion.div>
      ...
      <div className="relative z-20 flex min-h-[580px] md:min-h-[650px] flex-col justify-center px-6 py-6 md:px-10 md:py-8 lg:px-16 lg:py-9">
        <div className="mx-auto w-full max-w-[1440px]">
          <div className="grid items-center gap-7 lg:grid-cols-[minmax(0,1.08fr)_minmax(360px,0.92fr)]">
            ...
            >
              <h1 className="max-w-[14ch] text-slate-900 text-[clamp(2.25rem,3.3vw,4.4rem)] leading-[0.94] font-semibold tracking-[-0.055em]">
                {content.headline}
              </h1>
              <p className="mt-5 max-w-[52ch] text-slate-600 text-base md:text-lg leading-relaxed">
                {content.description}
              </p>
              <div className="mt-6">
                <Button
            ...
            <motion.div
              ...
              className="w-full lg:justify-self-end lg:max-w-[40rem] rounded-[2rem] rounded-tr-[2.6rem] border border-slate-200 bg-white/90 px-6 py-6 shadow-[0_24px_80px_rgba(15,23,42,0.12)] backdrop-blur-md md:px-8 md:py-8 lg:px-9 lg:py-9"
            >
              <div className="max-w-xl">
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="rounded-[1.4rem] border border-slate-200 bg-slate-50 p-4">
                    <p className="text-xs uppercase tracking-[0.25em] text-slate-500 mb-2">Governance</p>
