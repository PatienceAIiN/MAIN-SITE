  ...
  return (
    <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-white px-6 pb-20 pt-28">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center text-center">
        ...
        <h1 className="max-w-6xl font-serif text-4xl font-normal leading-[1.04] tracking-[-0.05em] text-[#1a1a1a] sm:text-6xl md:text-7xl">
          {content.headline}
        </h1>
        ...
        <button
          ...
          className="mt-12 inline-flex rounded-full bg-[#1a1a1a] px-14 py-5 text-base font-medium text-white shadow-xl transition-transform duration-300 hover:scale-[1.03]"
        >
          {content.cta.label}
        </button>
      </div>
