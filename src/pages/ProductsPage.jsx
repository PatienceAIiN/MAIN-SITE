  ...
  return (
    <main className="bg-white pt-24">
      <PageHero
        ...
        coverVideo="https://videos.pexels.com/video-files/3163534/3163534-sd_960_540_30fps.mp4"
      >
        <motion.button
          type="button"
          onClick={() => navigate('/company/podcast?tab=product')}
        ...
        {products.map((product, index) => (
          ...
          >
            <div className="relative h-64 overflow-hidden bg-[#f4f4f4] md:h-80">
              ...
              <img
                src={product.image || `https://images.unsplash.com/photo-1557200134-90327ee9fafa?q=80&w=1200&auto=format&fit=crop`}
                alt={product.name}
