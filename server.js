...
import podcastUrlHandler from './api/podcast-url.js';
import podcastTranslateHandler from './api/podcast-translate.js';
import blogPodcastHandler from './api/blog-podcast.js';
...
app.get('/api/podcast-url', podcastLimiter, wrap(podcastUrlHandler));
app.all('/api/podcast-translate', podcastLimiter, wrap(podcastTranslateHandler));
